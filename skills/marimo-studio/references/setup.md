...
came from a disposable terminal environment, read the installed briefing after
connecting to the notebook through Marimo's Code Mode sidebar or `marimo-pair`:
