...
export const hostSessionConfigSchema = hostSessionRecordSchema.extend({
  handoff: z.string(),
  key: z.string(),
  resume: z.string(),
...
export const parseHostSessionRecord = (value: JsonValue): HostSessionRecord =>
  hostSessionRecordSchema.parse(value);
