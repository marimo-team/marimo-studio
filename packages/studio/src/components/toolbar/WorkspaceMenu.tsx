...
import { MoreIcon, PopoutIcon } from "../icons.tsx";
...
export const WorkspaceMenu = ({
  ...
  onLayoutAction: (action: WorkspaceAction) => void;
  ...
  >
    <summary className="studio-toolbar-action" aria-label="Workspace options">
      <MoreIcon />
    </summary>
