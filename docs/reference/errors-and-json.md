...
description: Stable JSON result, JSON Lines diagnostic, HTTP error, Python exception, and exit-status contracts.
---
...
- Standard error contains one JSON object per diagnostic line.
...
| `StaticExportError`                | `static-export-error`           |  `3` |                  `500` | Repair the source or destination named by the message         |
